...
export const SkipSelection: React.FC = () => {
    ...
    const [showPermitCheck, setShowPermitCheck] = useState(false);
    ...
    const handleContinue = () => {
        setShowPermitCheck(true);
    };

    const handleBack = () => {
        setShowPermitCheck(false);
    };

    const handlePermitCheckContinue = (location: 'private' | 'public') => {
        // Handle the permit check result
        console.log('Skip location:', location);
        // TODO: Navigate to next step
    };

    if (showPermitCheck && selectedSkip) {
        return (
            <PermitCheck
